...
Public Class DirectlyEdit
    Private Sub DirectlyEdit_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        'TODO: This line of code loads data into the 'OptimizationDatabaseDataSet2.part' table. You can move, or remove it, as needed.
        Me.PartTableAdapter.Fill(Me.OptimizationDatabaseDataSet2.part)
    ...
    Private Sub Button2_Click(sender As Object, e As EventArgs)
        ...
        For it = 0 To DataGridView2.RowCount - 1
            cmd.CommandText = "INSERT INTO parts VALUES('" + DataGridView2.Rows(it).Cells(0).Value.ToString + "', '" + DataGridView2.Rows(it).Cells(1).Value.ToString + "' , '" + DataGridView2.Rows(it).Cells(2).Value.ToString + "', '" + DataGridView2.Rows(it).Cells(3).Value.ToString + "' , '" + DataGridView2.Rows(it).Cells(4).Value.ToString + "', " + DataGridView2.Rows(it).Cells(5).Value.ToString + " , " + DataGridView2.Rows(it).Cells(6).Value.ToString + ", " + DataGridView2.Rows(it).Cells(7).Value.ToString + ", '" + DataGridView2.Rows(it).Cells(8).Value.ToString + "','" + DataGridView2.Rows(it).Cells(9).Value.ToString + "','" + DataGridView2.Rows(it).Cells(10).Value.ToString + "'," + DataGridView2.Rows(it).Cells(11).Value.ToString + ", '" + DataGridView2.Rows(it).Cells(12).Value.ToString + " ')"
            cmd.ExecuteNonQuery()
        Next
        Me.StockNewTableAdapter.Fill(Me.OptimizationDatabaseDataSet.stockNew)
    End Sub
