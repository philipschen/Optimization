...
Public Class DirectlyEdit
    ...
    Private Sub Button2_Click(sender As Object, e As EventArgs) Handles Button2.Click
        ...
        For it = 0 To DataGridView1.RowCount - 1
            cmd.CommandText = "INSERT INTO parts VALUES('" + DataGridView1.Rows(it).Cells(0).Value.ToString + "', '" + DataGridView1.Rows(it).Cells(1).Value.ToString + "' , '" + DataGridView1.Rows(it).Cells(2).Value.ToString + "', '" + DataGridView1.Rows(it).Cells(3).Value.ToString + "' , '" + DataGridView1.Rows(it).Cells(4).Value.ToString + "', " + DataGridView1.Rows(it).Cells(5).Value.ToString + " , " + DataGridView1.Rows(it).Cells(6).Value.ToString + ", " + DataGridView1.Rows(it).Cells(7).Value.ToString + ", " + DataGridView1.Rows(it).Cells(8).Value.ToString + ",'" + DataGridView1.Rows(it).Cells(9).Value.ToString + "','" + DataGridView1.Rows(it).Cells(10).Value.ToString + "'," + DataGridView1.Rows(it).Cells(11).Value.ToString + ", '" + DataGridView1.Rows(it).Cells(12).Value.ToString + " ')"
            cmd.ExecuteNonQuery()
        Next
        Me.StockNewTableAdapter.Fill(Me.OptimizationDatabaseDataSet.stockNew)
    End Sub
